function [pert, sol] = compute_linearized_problem(alpha, lambda_tol, params)
%COMPUTE_LINEARIZED_PROBLEM Integrate linearized problem.
%
%   Integrate linearized problem from the shock with initial conditions
%   given by linearization of the Rankine--Hugoniot conditions.
%   Return final values of the perturbations.
%
%   Parameters
%   ----------
%   alpha : complex
...
%   -------
%   pert : struct
%       Structure containing final value of perturbations. Fields:
%       u : complex
%           Perturbation of u.
%       lambda : complex
%           Perturbation of lambda.
%
ic = [2*alpha 0];
